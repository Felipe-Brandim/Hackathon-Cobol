******************************************************************
      ...
      * DATA......: 03/07/2026
      * OBJETIVO..: Processamento completo com chamada de subprograma
      * EXECUCAO..: COBOL - BATCH
      * ----------------------------------------------------------------
      * VRS DATA     RESPONSAVEL     DESCRICAO DA VERSAO
      * --- -------- --------------- ----------------------------------
      * 001 03.07.26 Felipe Brandim  IMPLANTACAO COM DOIS ARQUIVOS
      * ----------------------------------------------------------------
******************************************************************
      ...
      *----------------------------------------
      * ESTRUTURA ESTÁTICA: Constantes do sistema e Area de Comunicacao
       01 WS-CONSTANTES.
      ...
      *----------------------------------------
      * ESTRUTURA DINÂMICA: Status de runtime, flags 88 e contadores
       01 WS-FILE-STATUS.
...
******************************************************************
       ...
       200000-ABRIR-ARQUIVOS.
           ...
           IF WS-FS-BHCF014S NOT = WS-FS-OK
              DISPLAY 'ERRO OPEN OUTPUT BHCF014S: ' WS-FS-BHCF014S
              ADD 1 TO GDA-TOT-ERROS
              SET GDA-FIM-SIM TO TRUE
           END-IF.
           ...
           IF WS-FS-BHCF014L NOT = WS-FS-OK
              DISPLAY 'ERRO OPEN OUTPUT BHCF014L: ' WS-FS-BHCF014L
              ADD 1 TO GDA-TOT-ERROS
              SET GDA-FIM-SIM TO TRUE
           END-IF.
       ...
       510000-GRAVAR-VALIDO.
           ...
           WRITE REG-BHCF014S.
           IF WS-FS-BHCF014S = WS-FS-OK THEN
              ADD 1 TO GDA-TOT-VALIDOS
           ELSE
              DISPLAY 'ERRO WRITE BHCF014S: ' WS-FS-BHCF014S
              ADD 1 TO GDA-TOT-ERROS
           END-IF.
       ...
       520000-GRAVAR-LOG.
           ...
           WRITE REG-BHCF014L.
           IF WS-FS-BHCF014L = WS-FS-OK THEN
              ADD 1 TO GDA-TOT-REJEITADOS
           ELSE
              DISPLAY 'ERRO WRITE BHCF014L: ' WS-FS-BHCF014L
              ADD 1 TO GDA-TOT-ERROS
           END-IF.

       900000-FECHAR-ARQUIVOS.
           CLOSE BHCF012S BHCF014S BHCF014L.
           MOVE FUNCTION CURRENT-DATE TO GDA-CURRENT-DATE.
