******************************************************************
      ...
      * DATA......: 03/07/2026
      * OBJETIVO..: Gerar arquivo sequencial de participantes
      * EXECUCAO..: COBOL - BATCH
      * ----------------------------------------------------------------
      * VRS DATA     RESPONSAVEL     DESCRICAO DA VERSAO
      * --- -------- --------------- ----------------------------------
      * 001 03.07.26 Felipe Brandim  IMPLANTACAO COM ARQUIVO SEQUENCIAL
      * ----------------------------------------------------------------
******************************************************************
      ...
      *----------------------------------------
      * ESTRUTURA ESTÁTICA: Capacidade maxima e definicao da tabela
      ...
      * Buffer de saida estruturado para montagem do registro posicional
       01 GDA-GR-BHCF0129.
      ...
      *----------------------------------------
      * ESTRUTURA DINÂMICA: Status de arquivos, indices e totalizadores
       01 GDA-FILE-STATUS.
...
******************************************************************
      ...
      * Carga obrigatoria respeitando a coluna 72 de leitura
      ...
      * Registro 00003 com nome em branco de proposito para o Ex 13
      ...
      * Registro 00005 com UF em branco de proposito para o Ex 13
       ...
       300000-ABRIR-ARQUIVO.
           ...
           ELSE
              DISPLAY 'ERRO AO ABRIR BHCF012S. STATUS: ' FS-BHCF012S
           ...
           IF GDA-TOT-ERROS = ZEROS
              PERFORM VARYING GDA-INDICE FROM 1 BY 1
                 UNTIL GDA-INDICE > 10
                      ...
                      WRITE REG-BHCF012S FROM GDA-GR-BHCF0129
                  
                      IF FS-BHCF012S = GDA-FS-OK
                         ADD 1 TO GDA-TOT-GRAVADOS
                      ELSE
                         DISPLAY 'ERRO WRITE BHCF012S. STATUS: '
                                 FS-BHCF012S
                         ADD 1 TO GDA-TOT-ERROS
                      END-IF
              END-PERFORM
